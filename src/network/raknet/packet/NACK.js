...
/**
 * Encode this.sequences into a NACK packet.
 * For simplicity, each sequence is encoded as a single record (no ranges).
 */
NACK.prototype.encode = function(){
